...
namespace BusinessLayer.NewFolder
{
    public class MSMQ
    {
        ...
        public void ReceiveFromQueue(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\admin\source\repos\EmployeeCoreAPI\BusinessLayer\MSMQServices\msmq.txt", true))
                {
                    file.WriteLine(data);
                }
